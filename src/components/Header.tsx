...
const Header = () => {
  ...
  return (
    <div className='border-b pt-2 pb-3 flex justify-between items-center md:px-20 px-5'>
        ...
        <button onClick={() => handleLogout()} className='py-2 px-3 bg-gray-200 rounded'>{user ? 'Logout' : 'Sign in'}</button>
    </div>
  )
}
